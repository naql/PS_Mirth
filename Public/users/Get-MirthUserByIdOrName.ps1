function Get-MirthUserByIdOrName {
    <#
    .SYNOPSIS
    ...
    BEGIN { 
        Write-Debug "Get-MirthUserByIdOrName Beginning"
    }
    PROCESS {
        ...
        $uri = $serverUrl + "/api/users/$UserIdOrName"
    ...
    END { 
        Write-Debug "Get-MirthUserByIdOrName Ending"
    }
